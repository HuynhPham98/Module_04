...
public class CategoryController {
    ...
    @GetMapping
    public ResponseEntity<Page<Category>> findAll(@PageableDefault(page = 0,size = 3,sort = "categoryId",direction = Sort.Direction.ASC) Pageable pageable) {
    ...
    public ResponseEntity<Page<Category>> searchCategories(@RequestParam String keyword,
                                                           @PageableDefault(page = 0,size = 3,sort = "categoryId",direction = Sort.Direction.ASC) Pageable pageable) {
